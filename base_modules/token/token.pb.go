...
// token parameters
type Params struct {
	TokenTaxRate      github_com_irisnet_service_sdk_go_types.Dec `protobuf:"bytes,1,opt,name=token_tax_rate,json=tokenTaxRate,proto3,customtype=github.com/gridironzone/service-sdk-go/types.Dec" json:"token_tax_rate" yaml:"token_tax_rate"`
	...
	MintTokenFeeRatio github_com_irisnet_service_sdk_go_types.Dec `protobuf:"bytes,3,opt,name=mint_token_fee_ratio,json=mintTokenFeeRatio,proto3,customtype=github.com/gridironzone/service-sdk-go/types.Dec" json:"mint_token_fee_ratio" yaml:"mint_token_fee_ratio"`
}
